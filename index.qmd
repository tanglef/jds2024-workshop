...
![](img/minority-report_header.webp){width="600" fig-align="center" .fragment}

:::{.fragment}

And then there was distill.pub @olah2017research
...
![](img/RIP.png){width="800" fig-align="center" .fragment }

::::

## Pre-Computo era (4) The Rise of the Pragmatic

[distill.pub](https://distill.pub)’s goals were right, but they outpaced themselves in terms of development complexity.

. . .

**Computo** is a fresh start with a pragmatic approach: leverage
what the scientific community is already using: Rmarkdown, Jupyter notebooks, etc.
