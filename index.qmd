...
:::{.fragment}
A path to understand the results and the process that led to them (unlike cooking…^[Even so, we may discuss the fact that blindly following recipes will not make you a good cook.])
:::
